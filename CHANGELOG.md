...
### Added
- Transcript output is extensible through per-execution builder and sink factories, with public Markdown/file defaults, readable decision-action names, separate action outcome summaries, and isolated custom transcript state.
