...
| Declarative decision workflows | JSON decision trees with bounded classifications, actions, bounded action-data summaries, predicates, budgets, and verdicts | [Decision Trees](https://alexnek.github.io/AICleverness/execution/decision-trees/) |
